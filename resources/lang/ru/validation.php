...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'notification' => [
            'message' => 'сообщения',
            'promotion' => 'промоакции и советы',
            'progress' => 'уроки и прогресс',
            'schedule' => 'обновления расписания',
            'direction' => 'направления'
        ],
        'level' => 'уровень английского',
        'corrections' => 'исправления',
        'goals' => "цели",
        'current_goal' => "основная цель",
        'biography' => "биография",
        'current_goals' => "основные цели",
        ...
        'lesson' => [
            ...
            'block_media' => 'медиа файлы блока',
            'title' => 'название урока'
        ],
        'general_course' => [
            'id' => 'идентификатор общеобразовательного курса',
        ],
        'question' => [
            'id' => 'идентификатор вопроса',
            'title' => 'название вопроса',
            'score' => 'баллы за вопрос',
            'options' => 'варианты ответов'
        ],
        'option' => [
            'id' => 'идентификатор выбранного варианта ответа',
            'title' => 'название варианта ответа',
            'is_correct' => 'правильный ответ'
        ],
        'test' => [
            'completion_time' => 'время завершения теста',
            'questions' => 'вопросы',
        ],
        'language' => 'язык',
        'country' => 'текущее местоположение',
        'timezone' => 'часовой пояс',
        'desktop_notifications' => 'уведомления на рабочий стол',
        'promocode' => 'промокод',
        'discount_on' => 'действие скидки',
        'limit' => 'лимит',
        'url' => 'ссылка'
    ],
